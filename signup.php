...
########################################################################################################################################################################################################################
    ...
    if(isset($_POST['firstname']) and isset($_POST['lastname']) and isset($_POST['username']) and isset($_POST['password']))
    {
        ...
        {
            $errorMsg = "The password contains invalid characters! It must contain only uppercase and lowercase letters and/or digits.";
        }

        else if(!passLengthValidation($_POST['password']))
        {
            $errorMsg = "The password is too short! It must be only at least 3 characters long.";
        }

        else if(!nameValidation($_POST['firstname']))
        {
            $errorMsg = "The firstname contains invalid characters! It must contain only uppercase and lowercase letters and/or hyphens.";
        }

        else if(!nameValidation($_POST['lastname']))
        {
            $errorMsg = "The lastname contains invalid characters! It must contain only uppercase and lowercase letters and/or hyphens.";
        }

        else if(!usernameValidation($_POST['username']))
        {
            $errorMsg = "The username contains invalid characters! It cannot contain whitespaces.";
        }
        ...
        {   
            ...
            else
            {
                ...
                $errorMsg = "An user with this username already exists!"; 
            }
        }
    }
...
<section class="container-fluid" id="container">
    <form action="signup.php" method="post" class="form-container text-white" style="background-color:rgba(0,0,0,0.5); padding:30px; box-shadow: 0px 0px 10px 0px;width:25rem; border-radius: 10px; transform: translate(-53%,0%);">
        ...
        <div class="form-group" id="form">
            ...
            <div>Do you have an account? <a class="text-success" href="login.php">Log In</a></div>
    ...
    ?>
        ...
        <button type="submit" class="btn text-black btn-block btn-success" style="border:1px solid gray;border-radius: 15px; box-shadow: 1px 1px 1px 0px rgba(0,0,0,0.75); ">Create Account</button>
    </form>
</section>
<!-- end main -->
<!-- Error popup -->

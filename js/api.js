...
dictionaryTranslate = {"Sunflower": "Sunflower", "Potato": "Potato", "Wheat" : "Wheat", "Rapeseed": "Rapeseed", "Soy": "Soy", "Maize": "Maize", "Grapes" : "Grapes", "Tomato" : "Tomato"};
...
function processData(){
    for (var key in dictionary){
        ...
        if(percentage < 30){
            ul.innerHTML += ('<li class="list-group-item"><div class="row align-items-center no-gutters"><div class="col"><h6 class="mb-0 text-dark"><strong>The forecast for the next few days predicts it is terrible for growing ' + dictionaryTranslate[key] + '.' + '</strong></h6><span class="text-xs"></span></div></div></li>');
            changecolor(progressBar, 'red');
        }
        else
            if(percentage < 70){
                ul.innerHTML += ('<li class="list-group-item"><div class="row align-items-center no-gutters"><div class="col"><h6 class="mb-0 text-dark"><strong>The forecast for the next few days predicts it is alright for growing ' + dictionaryTranslate[key] + '.' + '</strong></h6><span class="text-xs"></span></div></div></li>');
                changecolor(progressBar, 'yellow');
            } 
            else
                if(percentage <= 100){
                    ul.innerHTML += ('<li class="list-group-item"><div class="row align-items-center no-gutters"><div class="col"><h6 class="mb-0 text-dark"><strong>The forecast for the next few days predicts it is excellent for growing ' + dictionaryTranslate[key] + '.' + '</strong></h6><span class="text-xs"></span></div></div></li>');
